...
import tweepy  # <--- NEW: Added for Twitter
...
# --- TWITTER BOT LOGIC (NEW) ---
def post_to_twitter(image_path, date_str):
    """Authenticates and posts the image to Twitter."""
    print("🐦 Attempting to tweet...")
    
    # Retrieve keys from GitHub Secrets (Environment Variables)
...
def main():
    ...
    # Optional: Wait to hit exactly :03 seconds (Though GitHub Actions isn't guaranteed precise)
    time.sleep(3) 
